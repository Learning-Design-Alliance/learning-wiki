---
type: theory
title: "Cognitive Load Theory: working-memory limits, human cognitive architecture, and three load types"
description: The article presents Cognitive Load Theory as a psychological theory from cognitive science, originated by John Sweller in the late 1980s, explaining how the design of learning materials affects learning given limited...
status: draft
generated:
...
### Context
#### Requirements
- Instructional design must consider the characteristics of the human cognitive system for materials to be efficient
#### Constraints
- The article notes CLT had not been extensively researched in the Algerian context at the time of writing

### Target Learners
- university foreign-language (EFL) students

### Target Learning Objectives
- designing instruction that fits working memory limits and avoids cognitive overload
