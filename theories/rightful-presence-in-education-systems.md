---
type: theory
title: "Rightful presence in education systems: a framework for building equity and justice at the systems level"
description: The brief defines rightful presence as a systems-level extension of a concept from sanctuary-city scholarship, reimagined for classrooms by Calabrese Barton and Tan and extended to education systems by SWIFT Education...
status: draft
generated:
...
### Context
#### Requirements
- Collective action from all parts of an educational system to change culture, policies, systems, and practices
#### Constraints
- The brief presents a conceptual framework with one illustrative example rather than empirical test data

### Target Learners
- students, families, and communities who experience systemic inequities
