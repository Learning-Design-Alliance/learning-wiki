...
1. **Social origin of thinking** — cognitive development cannot be understood apart from its social and historical context; learners adopt shared strategies and knowledge through working with others (Rogoff's "guided participation").
2. **Mediation by psychological tools, especially language** — social and individual functioning is mediated by signs and tools (language, counting systems, cultural artifacts); learners appropriate these tools rather than reinventing them, and language plays the dual role of enabling communication and constructing meaning.
3. **The Zone of Proximal Development (ZPD)** — "the distance between the actual developmental level as determined by independent problem solving and the level of potential development as determined through problem solving under adult guidance or in collaboration with more capable peers" (Vygotsky, 1978, p. 86). Learning is most productive when instruction is aimed at this zone rather than at what a learner can already do alone.

Sociocultural theory stands in explicit contrast to Piaget's view that developmental stages are biologically determined and precede learning; Vygotsky instead held that learning drives development. This has direct instructional consequences: rather than waiting for learners to be developmentally "ready," instruction can be structured to promote development by working just ahead of a learner's independent capability.

**Scaffolding** is the practical corollary of the ZPD: the mutual, dynamic set of tools or actions — modeling, prompting questions, highlighting critical features — that a more capable other provides to help a learner complete a task within their ZPD, gradually withdrawn as competence increases (Polly et al., 2018).
...
#### Constraints
- The ZPD is difficult to measure precisely — there is no common metric, and it is unclear whether a learner's zone is comparable across domains or stable over time (Miller, 2011)
- Vygotsky's own work was left incomplete by his early death and was not widely known in the West until decades later, so some of the theory's specifics remain underdeveloped
