...
### Context
#### Requirements
- Placement decisions must be judged against both proximity to regular educational settings and opportunities for interaction with non-handicapped children, as established by P.L. 94-142 and Section 504
#### Constraints
- The statute uses the phrase only once and neither the statute nor subsequent federal policy statements define precisely how agencies are expected to implement the law

### Target Learners
- Handicapped children aged 3 through 21 in United States public education
