...
### Context
#### Requirements
- Serves as an interpretive lens when comparing philosophies in Chapters 3 and 4.
#### Constraints
- The distinction is drawn from Stone and Schneider's Foundations of Education, as cited by Apps.

### Target Learners
- adult educators

### Target Learning Objectives
- locating one's own beliefs on the ends-means axis
