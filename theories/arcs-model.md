...
- **Attention** — learner attention must be captured and then sustained. Keller identifies three tactics: *perceptual arousal* (capturing interest via sensory/emotional surprise — an unexpected change, a sudden pause), which is transitory and conceptually close to *triggered situational interest* in [Hidi and Renninger's four-phase interest model](four-phase-interest-development.md); *inquiry arousal* (cognitive-level curiosity, e.g. paradoxical facts, posing a question or problem to solve), which lasts longer and parallels that model's *maintained situational interest*; and *variability* (incorporating a range of methods and media to meet varying student needs, since any single tactic loses potency with repetition).
- **Relevance** — the learner must perceive the task as personally meaningful. Keller draws this directly from goal theory (Locke & Latham, 1984) and the perceived-value construct shared by [Expectancy-Value Theory](expectancy-value-theory.md) and [Self-Determination Theory](self-determination-theory.md) (Deci & Ryan, 2000; Wigfield & Eccles, 1992): tactics include presenting objectives and methods framed around useful purpose ("motive matching" — matching objectives to students' own needs and motives), and presenting content in ways that connect to learners' familiar experiences and values.
- **Confidence** — the learner must believe success is achievable through their own effort. This category draws directly on [Self-Efficacy Theory](self-efficacy-theory.md) and the expectancy component of [Expectancy-Value Theory](expectancy-value-theory.md) — Keller explicitly ties unmet [Self-Determination Theory](self-determination-theory.md) competence needs to low expectancies and low self-efficacy, which in turn produce poor motivation (Bandura, 1997; Ryan & Deci, 2000; Wigfield & Eccles, 2000): strategies include informing students of learning/performance requirements and assessment criteria up front, engineering challenging-but-achievable success opportunities, and fostering a sense of control over one's own performance by linking success explicitly to personal effort and ability (autonomy support, choices, internal-controllable attributions).
- **Satisfaction** — the learner needs the outcome to feel rewarding, whether through intrinsic consequences (a feeling of mastery, the pleasure of a challenge overcome) or extrinsic ones (positive reinforcement, motivational feedback, grades, certificates) — but extrinsic rewards only produce satisfaction when they don't feel hollow relative to the effort involved, and consistent standards/consequences (equity) matter as much as the reward itself: a student who aces a test they know was trivially easy typically feels no genuine satisfaction from the high score, however extrinsically rewarding it looks on paper (Skinner, 1963; Ryan & Deci, 2000; Keller, 2010).

Keller organizes concrete tactics for each category into finer sub-tactics:

| | Attention | Relevance | Confidence | Satisfaction |
|---|---|---|---|---|
| 1 | Perceptual arousal — novelty and surprise | Goal orientation — present objectives and useful purpose | Learning requirements — state performance/assessment criteria up front | Intrinsic reinforcement — support intrinsic enjoyment of the task |
| 2 | Inquiry arousal — pose questions/problems to stimulate curiosity | Motive matching — match objectives to student needs and motives | Successful opportunities — provide challenging, meaningful chances to succeed | Extrinsic rewards — positive reinforcement and motivational feedback |
| 3 | Variability — vary methods/media for different student needs | Familiarity — connect content to learners' experiences and values | Personal responsibility — link success to personal effort and ability | Equity — maintain consistent standards and consequences |
...
- Arduini-Van Hoose, N. (2020). Keller's ARCS model: Integrating ideas about motivation. In *Educational psychology*. Retrieved from https://edpsych.pressbooks.sunycreate.cloud. CC BY-NC-SA 4.0.
