---
type: theory
title: "CRESST model of learning: five families of cognitive learning as assessment targets"
description: "The CRESST model of learning organizes assessment around five types of learning: content understanding, problem solving, communication, collaboration, and metacognition."
status: draft
generated:
...
### Context
#### Requirements
- New assessment tools must measure one or more components of the CRESST model of learning
#### Constraints
- The model is used as a design framework for assessment tools; the report presents no validation evidence for the model itself

### Target Learners
- K-12 and adult learners assessed with computer-based performance tasks
