---
type: theory
title: "Dewey's pedagogical principles: school as life itself, no subject with educational value on its own, and education for all citizens"
description: The article presents a set of Deweyan pedagogical principles against which it evaluates the Turkish education project.
status: draft
generated:
...
### Context
#### Requirements
- The framework is applied as a philosophical lens for evaluating education systems' alignment with libertarian and democratic values
#### Constraints
- The article notes Dewey in Turkey was discovered late, often misunderstood and misintroduced, and seen only as an education philosopher

### Target Learners
- all citizens, per Dewey's democratic requirement of education for all

### Target Learning Objectives
- democratic citizenship and the intrinsic value of education

### Claims
- [Top Down Education Method Contradicts Dewey](../claims/top-down-education-method-contradicts-dewey.md) [+M]
- [Dewey Localization Autonomy Unimplemented Turkish Education](../claims/dewey-localization-autonomy-unimplemented-turkish-education.md) [+M]
