---
type: theory
title: AAC decision-making framework organized around unaided versus aided system options
description: "The article organizes AAC selection as a decision process across decision points, grounded in the taxonomy that \"AAC systems can be divided into two broad categories, unaided and aided.\" Unaided AAC involves symbols s..."
status: draft
generated:
...
### Context
#### Requirements
- Decision-making must account for each child's unique cognitive, motor, and communication abilities and barriers, and the advantages, disadvantages, and limitations of each AAC system.
#### Constraints
- The decision-making process is complicated even for skilled practitioners due to variability across AAC systems and individual differences.

### Target Learners
- Children and individuals with developmental disabilities including autism who do not use speech functionally

### Target Learning Objectives
- Expressive communication of wants, needs, feelings, and ideas

### Claims

- [No Consistent Pe Vs Sgd Effectiveness Differences](../claims/no-consistent-pe-vs-sgd-effectiveness-differences.md) [+M]
...
- [Heterogeneity across reviewed single-subject studies limits broad AAC comparisons, warranting more focused syntheses](../claims/heterogeneity-limits-aac-reviews.md) [~M]
