---
type: theory
title: Polytomous DFIT framework for differential item and test functioning
description: An IRT-based parametric procedure proposed by Raju, van der Linden, and Fleer (1995) for detecting differential item functioning and differential test functioning in polytomously scored data.
status: draft
generated:
