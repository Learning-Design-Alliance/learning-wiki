---
type: theory
title: "The Janusian process: actively conceiving multiple opposites simultaneously as a mechanism of creativity"
description: "The Janusian process is defined in the article as \"actively conceiving multiple opposites or antitheses simultaneously\", named for the Roman god Janus whose faces looked in multiple opposite directions."
status: draft
generated:
...
### Context
#### Requirements
- A concept or theory is needed as the object of the process, with thematic elements that can be identified and opposed
#### Constraints
- In this study the process was examined only via opposite and paradoxical conceptions in concepts, paintings and drawings

### Target Learners
- primary school students
- students in any domain where concepts can be opposed

### Target Learning Objectives
- creative thinking
- generating original conceptions from opposites
