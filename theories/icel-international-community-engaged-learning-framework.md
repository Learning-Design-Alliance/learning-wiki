---
type: theory
title: International community-engaged learning (ICEL) as an experiential education process combining societal engagement, a global challenge, and collaboration
description: "ICEL is defined in the article as \"an experiential education process involv - ing collaborative efforts among students, teachers, and societal partners to tackle global challenges.\" The framework treats wicked problem..."
status: draft
generated:
...
### Context
#### Requirements
- Collaboration outside the academic world with those experiencing and working to tackle the issues on a local level, requiring tailored solutions
#### Constraints
- In the first editions of the course the components were integrated independently of each other

### Target Learners
- higher education students across disciplines

### Target Learning Objectives
- transformative competencies for tackling wicked global planetary health challenges
