---
type: theory
title: Two-dimensional model of group growth (community problems and group problems, with growth, regression, and plateaus)
description: The study defines group growth operationally as developing the capacity to solve increasingly complex problems, both the community problem a group attempts and problems of group operations.
status: draft
generated:
...
### Context
#### Requirements
- Groups must continue to solve problems of greater and greater difficulty for growth to continue
#### Constraints
- The research methodology did not yield good evidence of regression and plateaus for group problems

### Target Learners
- citizen members of community problem-solving groups
