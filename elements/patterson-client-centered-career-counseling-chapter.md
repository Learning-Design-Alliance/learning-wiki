---
type: element
id: patterson-client-centered-career-counseling-chapter
title: "Patterson's chapter on client-centered career counseling"
description: "In the 1960s, Henry Borow commissioned Patterson to write a chapter for \"Man in a World at Work\", the fiftieth anniversary publication of the National Vocational Guidance Association."
status: draft
generated:
...
### Context
#### Requirements
- A commissioning editor and venue (the NVGA anniversary volume) to publish the statement, as the chapter arose from Borow's invitation.
#### Constraints
- Rogers never wrote on client-centered career counseling, per Patterson, so the chapter had no direct Rogers source to draw on.
