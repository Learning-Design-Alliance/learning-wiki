---
type: element
id: koku-digital-falls-prevention-programme
title: Keep-On-Keep-Up (KOKU) digital falls prevention programme
description: "KOKU is an NHS-approved, tablet-delivered digital programme offering \"a progressive strength and balance programme with animated characters (eCoaches) providing instructions, guidance, safety information, automated re..."
status: draft
generated:
...
### Context
#### Requirements
- A tablet device and initial training at baseline to familiarise participants with using the programme, with ad hoc technical support available
#### Constraints
- Several participants faced technical glitches and confusion regarding the dose of each exercise; the programme was felt by some to offer insufficient challenge for higher-functioning users and to feel relatable only to White Caucasian older adults
