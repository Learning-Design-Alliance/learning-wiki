---
type: element
id: philippine-adult-education-eight-type-taxonomy
title: Schematic taxonomy of eight types of adult education in the Philippines (Table 2)
description: "The article constructs a schematic analysis (Table 2) dividing Philippine adult education into eight types across two streams: formal vocational/technical (items 1-2: vocational trade high schools and post-secondary v..."
status: draft
generated:
...
### Context
#### Requirements
- Serves as an analytical map for identifying which sectors receive funding and which are neglected
#### Constraints
- The bulk of government funds goes to items 1, 2, and 4, while DECS-BNFE (item 3) gets the lowest funding of all bureaus under the Department of Education

### Target Learners
- Adult learners across vocational, literacy, livelihood and political education sectors in the Philippines
