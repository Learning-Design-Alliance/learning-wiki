...
### Context
#### Requirements
- **A conceptually difficult target**
- **Supports that clarify underlying relationships or meaning**
#### Constraints
- **Supports should eventually be reduced so learners can reason independently**
