...
> **Evidence** · 4 claims (3 for, 1 against) · 6 studies, `q2`–`q4` · 5 of 6 report an effect size · 2 claims rest on one study
...
**This is not Gagné's nine events.** The nine events are a lesson-level method — what happens inside one instructional episode — and are described at [Gagné's 9 Events of Instruction](../patterns/gagnes-9-events-of-instruction.md). This page is the course-level process that decides which lessons should exist at all. Gagné contributed to both, which is why they are routinely conflated.
...
2. **Conduct an instructional analysis** — decompose the goal into subordinate skills and their prerequisite relations. [Task Analysis](../methods/task-analysis.md), [Learning Hierarchy Task Analysis](../methods/learning-hierarchy-task-analysis.md) and, where the demands are judgemental rather than procedural, [Cognitive Task Analysis](../methods/cognitive-task-analysis.md)
3. **Analyse learners and context** — entry behaviours, characteristics, and the setting of both instruction and performance. [Learner and Context Analysis](../methods/learner-and-context-analysis.md), [Needs Analysis](../methods/needs-analysis.md)
...
8. **Design and conduct formative evaluation** — one-to-one, small group, field trial.
...
- **Where the goal is externally set**, steps 1–2 are partly done for you: a [standards crosswalk](../methods/standards-crosswalk.md) supplies the goal tree and its codes, and the analysis begins at the subordinate-skill level
...
## Related Processes
- [Gagné's 9 Events of Instruction](../patterns/gagnes-9-events-of-instruction.md) — the lesson-level method inside step 6, explicitly not this process
