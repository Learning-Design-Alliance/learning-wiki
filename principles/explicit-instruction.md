...
### Claims
- [[claims/contingent-scaffolding-improves-learning]] [+M] — explicit teaching is more effective when guidance adapts to what learners actually understand and can do
- [[claims/worked-examples-example-problem-sequences]] [~M] — novices often learn initial routines more effectively from modeled examples followed by closely related practice
