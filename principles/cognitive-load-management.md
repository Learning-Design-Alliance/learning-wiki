...
## Implications
Cognitive load management matters when instruction risks overwhelming working memory before learners have formed stable schemas. In practice, this means chunking information and removing unnecessary complexity so learners can devote more attention to the underlying idea or procedure [[claims/chunking-reduces-working-memory-load]] [+S]. These moves usually make early learning more manageable, but the same supports can become inefficient once learners are more knowledgeable, so guidance should fade or simplify as expertise grows [[claims/expertise-reversal-effect]] [~M].
...
### Claims
- [[claims/chunking-reduces-working-memory-load]] [+S] — reducing unnecessary processing and organizing material into coherent units preserves capacity for schema formation
- [[claims/expertise-reversal-effect]] [~M] — supports that help novices can become inefficient or redundant as learner expertise increases
