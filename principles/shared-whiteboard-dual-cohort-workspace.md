---
type: principle
id: shared-whiteboard-dual-cohort-workspace
title: Use a shared synchronous whiteboard as the common workspace for both face-to-face and online cohorts
description: "The article shows a teacher uploading slides to the Collaborate whiteboard rather than projecting them, so that \"both cohorts to see, write and highlight the contents on the slides to help with their task completion\"."
status: draft
generated:
