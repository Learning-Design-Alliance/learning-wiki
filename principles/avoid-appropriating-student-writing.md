---
type: principle
id: avoid-appropriating-student-writing
title: Avoid appropriating student writing; distinguish appropriation from helpful intervention
description: "Teachers may inadvertently take over a student's voice and creativity by imposing too much control and authority, to the point that a paper looks like it belongs to the teacher."
status: draft
generated:
...
### Context
#### Requirements
- Teachers must check whether commentary preserves the student's purpose, point of view, and intended meaning rather than shifting them
#### Constraints
- Part of the teacher's job is still to provide guidance, critique, and correction, so appropriation must be distinguished from necessary suggestions

### Target Learners
- student writers, particularly ESL and second language writers

### Target Learning Objectives
- writer agency and voice
