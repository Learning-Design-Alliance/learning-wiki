---
type: principle
id: structure-with-student-control-cross-cultural-tasks
title: Balance teacher support with student control when designing constructivist language activities
description: The article recommends that teachers create structures offering support while leaving learners a degree of control, so activities remain guided but personalizable.
status: draft
generated:
