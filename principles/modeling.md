...
### Context
#### Requirements
- **A visible model of performance, not just a finished product** — learners need to see process, not only outcome
- **Narration or annotation of reasoning** — effective models explain why moves are made, not just what happens
- **A link to subsequent learner practice** — modeling is preparatory; it should immediately support guided or independent performance
#### Constraints
- **Silent demonstration can hide the real cognition** — learners may copy form without understanding the reasoning
- **Overly expert performance can move too fast for novices** — teachers often need to slow down, segment, or annotate the model
- **Modeling alone does not ensure transfer** — learners still need practice, feedback, and reflection

### Target Learners
- Novices who need to see what successful performance looks like in process terms
- Learners acquiring complex cognitive or procedural skills where key decisions are otherwise tacit
- Learners who benefit from explicit examples before attempting a task independently

### Target Learning Objectives
- Make expert decision-making and process visible
- Reduce ambiguity about standards, sequence, and quality
- Prepare learners to attempt similar work with support and then independently

### Theory
#### Supporting
- [Cognitive Apprenticeship](/principles/cognitive-apprenticeship.md) — modeling is the opening move in apprenticeship-style instruction because it externalizes otherwise tacit expertise
- [Worked Examples](/principles/worked-examples.md) — worked examples are one of the clearest forms of modeling for novices
...
## Related Principles
- [Observation/Shadowing](/principles/observationshadowing.md) — both principles rely on seeing performance, but modeling is usually more intentionally annotated and instructional
- [Explicit Instruction](/principles/explicit-instruction.md) — modeling is one of the core mechanisms that makes explicit teaching actually explicit
- [Cognitive Apprenticeship](/principles/cognitive-apprenticeship.md) — extends modeling into coaching, scaffolding, and fading
