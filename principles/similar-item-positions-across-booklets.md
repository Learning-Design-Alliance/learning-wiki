---
type: principle
id: similar-item-positions-across-booklets
title: Position the same items in similar locations across different test booklets to avoid position-related DIF
description: This test-assembly principle holds that when multiple booklets are formed from the same items, the items should occupy similar positions in each booklet.
status: draft
generated:
