...
- [Pairing worked examples with practice or fading supports transfer better than examples alone.](/claims/worked-examples-with-practice-improve-transfer.md) [+S] — pairing examples with practice or fading supports transfer
...
## Related Principles
- [Purposeful Reflection](/principles/purposeful-reflection.md) — worked examples gain power when paired with structured prompts to reflect on why each step was taken
- [Guided Practice](/principles/guided-practice.md) — provides the scaffolded practice phase that converts example study into transferable performance
- [Explaining Their Thinking](/principles/explaining-their-thinking.md) — self-explanation of worked examples is one of the strongest amplifiers of example-based learning
- [Pairing Non-Examples With Examples](/principles/pairing-non-examples-with-examples.md) — extends worked examples by contrasting correct solutions with common errors, sharpening discrimination
