...
## Related Principles
- [Simulations & Immersive Virtual Environments](/principles/simulations-immersive-virtual-environments.md) — simulations overlap with game-based learning when the experience models a system learners must navigate.
- [Immediate Feedback](/principles/immediate-feedback.md) — games depend on fast consequence signals to support adaptation and persistence.
- [Error Analysis](/principles/error-analysis.md) — game loops often create repeated opportunities to learn from mistakes.
- [Guided Practice](/principles/guided-practice.md) — many instructional games work best after some initial modeling or guided rehearsal.
