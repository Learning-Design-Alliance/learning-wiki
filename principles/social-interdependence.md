...
> **Evidence** · 2 claims (2 unmarked) · 4 studies, `q2`–`q3` · 4 of 4 report an effect size
...
### Context
#### Requirements
- **A task where learners' efforts meaningfully affect one another**
- **Clear shared goals and accountability**
#### Constraints
- **Poorly structured interdependence can lead to free-riding or conflict**

### Target Learning Objectives
- Improve cooperation, shared responsibility, and collaborative reasoning.
