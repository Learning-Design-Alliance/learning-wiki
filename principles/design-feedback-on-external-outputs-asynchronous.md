---
type: principle
id: design-feedback-on-external-outputs-asynchronous
title: Design asynchronous online activities so that external outputs receive formative feedback, enabling higher ICAP modes
description: The article recommends explicitly designing task-based formative feedback into asynchronous online learning activities so that student-produced external outputs are used to move thinking to higher engagement modes.
status: draft
generated:
