...
- [[claims/whole-task-performance-improves-transfer]] [+S] aligns with case-based learning when the case requires integrating multiple concepts into a coherent response
...
- Transfer is stronger when learners articulate why a response fits the case rather than merely selecting an option [[claims/self-explanation-improves-conceptual-understanding]] [+S]
- Facilitation matters: questioning and hints often outperform simply telling learners what the right answer was [[claims/contingent-scaffolding-improves-learning]] [+M]

### Claims
- [[claims/whole-task-performance-improves-transfer]] [+S] — cases can approximate whole-task professional reasoning better than isolated subskill drills
- [[claims/self-explanation-improves-conceptual-understanding]] [+S] — discussion and written justification improve learning when learners explain why their interpretation fits the evidence
- [[claims/contingent-scaffolding-improves-learning]] [+M] — instructor probing and responsive hints improve transfer more than answer-giving alone
- [[claims/part-task-practice-reduces-load-for-novices]] [~M] — some novices need component instruction or worked examples before cases become productive

## Related Principles
- [[principles/authentic-audiences-purposes|Authentic Audiences & Purposes]] — cases become stronger when decisions are framed for realistic stakeholders
- [[principles/inquiry-based-learning|Inquiry-based Learning]] — case work often begins with uncertainty, question generation, and evidence seeking
- [[principles/explaining-their-thinking|Explaining Their Thinking]] — case analysis depends on visible reasoning, not just chosen conclusions
- [[principles/ask-experts|Ask Experts]] — expert commentary can make tacit judgment visible after learners attempt a case themselves

## Examples
<!-- Links to elements or patterns that apply this principle -->
- [[patterns/case-based-learning-harvard-method|Case-Based Learning (Harvard Method)]] — structured whole-class analysis of a complex case
- [[strategies/case_studies|Case Studies]] — localized use of real or simulated scenarios for application and discussion
