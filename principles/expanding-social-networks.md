...
- [Self-explanation improves conceptual understanding and problem-solving performance.](/claims/self-explanation-improves-conceptual-understanding.md) [+S] — networks become more educative when learners explain problems, reasoning, and goals clearly to others
...
## Related Principles
- [Communities of Practice](/principles/communities-of-practice.md) — networks deepen when they become recurring communities around shared work
- [Ask Experts](/principles/ask-experts.md) — expert access is often a key reason to expand networks
- [Check-ins](/principles/check-ins.md) — regular low-stakes contact can help relationships form before higher-stakes support is needed
- [Cultural & Life Experiences Connections](/principles/cultural-life-experiences-connections.md) — network-building should respect and build from learners’ existing communities and identities
