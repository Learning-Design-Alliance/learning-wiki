...
### Context
#### Requirements
- **A clear reason for the learning to matter** — learners need some sense of value, relevance, challenge, or personal significance
- **Tasks with an achievable but meaningful level of challenge** — motivation drops when work feels either trivial or impossible
#### Constraints
- **Attention-grabbing tactics alone do not sustain motivation**
- **Motivation changes over time** — what initially draws learners in may not be what keeps them going
- **External reward can distort effort** — incentives can help, but they may also narrow attention or weaken ownership if overused

### Target Learners
- Learners at risk of low persistence, passivity, or disengagement
- Learners who need stronger ownership, purpose, or confidence to stay with challenging work
- Learners in long-duration or effortful tasks where persistence is a major mediator of success

### Target Learning Objectives
- Increase readiness, persistence, and willingness to engage effortfully
- Improve the likelihood that learners will stay with difficult tasks long enough to benefit
- Strengthen ownership and purpose around learning goals
