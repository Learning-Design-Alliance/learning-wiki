...
- **Interpretation support**: Instructors should prompt learners to explain what the visual means, not only produce it [[claims/self-explanation-improves-conceptual-understanding]] [+S].
...
- **Cognitive overload**: Highly complex diagrams can overwhelm novices unless structure is chunked or scaffolded [[claims/chunking-reduces-working-memory-load]] [+S].
...
- [[principles/metaphors-analogies|Metaphors & Analogies]] — visual representations often help concretize analogical relationships.
- [[principles/multimodal-instruction|Multimodal Instruction]] — creating visuals complements learning across multiple modes.
- [[principles/explaining-their-thinking|Explaining Their Thinking]] — the strongest visual tasks usually require verbal or written explanation alongside the artifact.
