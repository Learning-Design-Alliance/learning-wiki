---
type: pattern
id: mild-disturbance-conventional-classroom-minimal-enclosure
title: Mild-disturbance classrooms approach conventional classrooms with minimal enclosed space
description: "At the mildest level the booklet reduces special provisions: \"In classrooms for mildly disturbed children there is less need for enclosed spaces such as quiet rooms and study carrels.\" Drawing 7 is fully open with no..."
status: draft
generated:
...
### Context
#### Requirements
- Retreat areas in two of the three drawings, enclosed by book shelving and screens rather than walls
#### Constraints
- Children in this class react less to activity around them, so fewer controls are needed

### Target Learners
- mildly emotionally disturbed children, including integrated placements

### Target Goals
- participation in a conventional classroom atmosphere with light behavioural support
