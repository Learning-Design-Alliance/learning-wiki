...
* **Policy**: [INCLUSION.md](INCLUSION.md) adopted: every paradigm in, logical evidence counts, design-process studies in, domain never excludes; opinion pieces rejected unless cited by five or more wiki pages, in which case ingested as q1 marked unsupported. New `opinion-piece` rejection code; prompt v130 (not live)
