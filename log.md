...
* **Deprecate**: `strategies/a_finders_guide_to_facts.md` — removed; corrupted duplicate of [strategies/a_finder's_guide_to_facts](strategies/a_finder's_guide_to_facts.md), inbound links retargeted
