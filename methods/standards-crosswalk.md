...
- Of little use where goals are genuinely open — there, [Design Thinking](../processes/design-thinking.md) derives the goals rather than inheriting them
...
- [Standards-Based Grading](../strategies/standards-based-grading.md) — the reporting practice the same codes make possible
