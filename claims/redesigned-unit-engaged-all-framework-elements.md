---
type: claim
title: The redesigned unit promoted engagement across all five elements of the Engagement Framework, including professional relevance rated 4.86 on SETL
description: The redesigned unit promoted engagement across all five elements of the Engagement Framework, including professional relevance rated 4.86 on SETL
id: redesigned-unit-engaged-all-framework-elements
status: draft
generated:
...
`q2 i?` SETL results showed a mean of 4.86 (1 = Strongly Disagree, 5 = Strongly Agree) for learning the subject's relevance to the future profession. [→ Pittaway 2014 (2)](#pittaway-2014-2)
...
> "Based on the evidence collected for this research project, it is clear that the redesigned unit was effective in promoting student engagement across all elements of the Framework."
...
> "SETL results indicate that other students found similar connections to their professional practice, with a mean score of 4.86 (where 1 = Strongly Disagree and 5 = Strongly Agree) in response to the item ‘I have learned the relevance of this subject to my future profession’."
