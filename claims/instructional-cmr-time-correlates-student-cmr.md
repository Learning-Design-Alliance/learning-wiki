---
type: claim
title: More instructional time spent on causal mechanistic reasoning correlated with a higher percentage of student responses using causal mechanistic reasoning on phenomenon-based tasks
description: More instructional time spent on causal mechanistic reasoning correlated with a higher percentage of student responses using causal mechanistic reasoning on phenomenon-based tasks
id: instructional-cmr-time-correlates-student-cmr
status: draft
generated:
...
`q2 i?` When emphasis on causal mechanistic reasoning rose to 24% or more of instructional time, students' use of it on tasks increased to 24−36%. [→ Scharlott 2024 (2)](#scharlott-2024-2)
...
> "In the core ideas learning environment, 50% of class time was invested in causal mechanistic reasoning, and 41% of students exhibited causal mechanistic reasoning on the lithium chloride dissolving in water."
...
> "We observed a similar trend in that 20% or fewer students exhibited causal mechanistic reasoning when explaining the phenomenon; however, when the emphasis on causal mechanistic reasoning rose to 24% or more, students' use of causal mechanistic reasoning increased to 24−36% on the task."
