---
type: claim
title: "Counselors exposed to 'sex trafficking' labels reported more victimization-oriented attitudes than counselors exposed to 'prostitute' labels"
description: "Counselors exposed to 'sex trafficking' labels reported more victimization-oriented attitudes than counselors exposed to 'prostitute' labels"
id: trafficking-labels-shift-counselor-attitudes-toward-victimization
status: draft
generated:
...
`q3 i?` The label difference held on all four attitude subscales (PNCV, PNND, PSCV, PSND), each significant at p < .01. [→ Litam 2019 (2)](#litam-2019-2)
...
> "The overall mean scores between APPS (M = 3.56, SD = .427) and ATTS groups (M = 3.80,  SD = .255), t (394) = -6.952, p < .01, were significantly different."
...
> "Four additional t-tests determined significant differences existed between each of the APPS and ATTS subscales."
