---
type: claim
title: Segmenting Principle Improves Multimedia Learning
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: segmenting-principle-improves-multimedia-learning
evidence_strength:
---
...
- [Cognitive load theory](../theories/cognitive-load-theory.md) — the theoretical framework underlying the segmenting principle
- [Expertise reversal effect](../theories/expertise-reversal-effect.md) — potential boundary condition for learners with high prior knowledge