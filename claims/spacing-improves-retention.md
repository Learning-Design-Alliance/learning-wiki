...
- [Chunking reduces working memory load.](chunking-reduces-working-memory-load.md) — chunking governs what can be encoded in each spaced episode
...
- [Cognitive overload degrades learning.](cognitive-overload-degrades-learning.md) — overloaded sessions undermine the encoding that spacing depends on
