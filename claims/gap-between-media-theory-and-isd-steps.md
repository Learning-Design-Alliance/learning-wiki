---
type: claim
title: A theoretical gap exists between delivery-system/media theory and instructional strategy theory and other ISD steps
description: A theoretical gap exists between delivery-system/media theory and instructional strategy theory and other ISD steps
id: gap-between-media-theory-and-isd-steps
status: draft
generated:
...
`q2 i?` Types of learning is the dominant theoretical thread connecting ISD steps, but it is difficult to relate types of learning to selection of delivery systems. [→ Seels 1997 (2)](#seels-1997-2)
...
> "Today, there is no widely accepted theory which follows in the tradition of the Cone of Experience. The result is a gap in instructional design theory which will be addressed next."
...
> "This theoretical thread dominates, it is difficult to relate types of learning to selection of delivery systems."
