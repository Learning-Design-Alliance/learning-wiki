---
type: claim
title: Highlighting Alone Is Ineffective
status: review
generated:
...
**Open questions.** The evidence base for this claim still needs to be filled in with controlled comparisons of highlighting against no-review and generative-strategy conditions; until then, the claim rests on strategy-survey syntheses and the general generative-processing account rather than on targeted experiments catalogued here.

## Related Claims

- [Annotating improves learning.](annotating-improves-learning.md) — generative marking (notes, questions) succeeds where passive highlighting fails
- [Coherence principle: irrelevant material hurts learning.](coherence-principle-irrelevant-material-hurts-learning.md) — extraneous visual emphasis, like indiscriminate highlighting, diverts attention from core content
- [Chunking reduces working memory load.](chunking-reduces-working-memory-load.md) — effective marking should segment material meaningfully, not just color it
- [Cognitive overload degrades learning.](cognitive-overload-degrades-learning.md) — unguided marking adds selection demands novices cannot yet manage