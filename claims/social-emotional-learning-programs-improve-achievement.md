---
type: claim
title: Social Emotional Learning Programs Improve Achievement
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: social-emotional-learning-programs-improve-achievement
evidence_strength:
---
...
**Note:** This page currently has no Evidence entries. Studies (e.g., large-scale meta-analytic syntheses of universal school-based SEL programs reporting academic achievement outcomes) still need to be added before the claim can be rated for strength. Until those entries are added, no effect direction or strength tags should be attached to claims on this page.

## Related Claims

- [Belonging interventions improve outcomes](belonging-interventions-improve-outcomes.md) — social connectedness is one proposed pathway from SEL to achievement
- [Autonomy supports intrinsic motivation](autonomy-supports-intrinsic-motivation.md) — motivation is a mediator between SEL competencies and academic engagement
- [Collaborative learning improves outcomes](collaborative-learning-improves-outcomes.md) — relationship skills underpin effective collaboration
- [Assessment for learning improves achievement](assessment-for-learning-improves-achievement.md) — self-management and goal-setting overlap with self-regulated learning practices