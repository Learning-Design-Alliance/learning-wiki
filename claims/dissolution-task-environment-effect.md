---
type: claim
title: "Learning environment significantly affected students' use of causal mechanistic reasoning on the dissolution task, with the core ideas environment highest at 40%"
description: "Learning environment significantly affected students' use of causal mechanistic reasoning on the dissolution task, with the core ideas environment highest at 40%"
id: dissolution-task-environment-effect
status: draft
generated:
...
`q3 i?` Percentages of causal mechanistic responses on the dissolution task differed across the three learning environments, with the core ideas environment highest. [→ Scharlott 2024 (2)](#scharlott-2024-2)
...
> "A chi-square test of independence indicated that for the dissolution task, the learning environment had a significant impact on student responses (χ2 = 47.86, p < 0.005, effect size = 0.352 {moderate})."
...
> "In the dissolution task, 20%, 19%, and 40% of students' responses exhibited causal mechanistic reasoning in the active, didactic, and core ideas learning spaces, respectively."
