---
type: claim
title: Interleaving Improves Transfer
status: review
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: interleaving-improves-transfer
...
- [Analogical reasoning improves transfer.](analogical-reasoning-improves-transfer.md) — interleaving works partly by inviting comparison between problem types, the same mechanism analogical comparison exploits
- [Chunking reduces working memory load.](chunking-reduces-working-memory-load.md) — interleaving raises processing demands; chunked material helps learners cope with the added load
- [Cognitive overload degrades learning.](cognitive-overload-degrades-learning.md) — interleaving too much novel material at once can overload novices and reverse the benefit
...
- [Worked examples can become redundant or counterproductive for advanced learners.](worked-examples-expertise-reversal.md) — both effects show that optimal practice difficulty shifts with expertise, supporting faded schedules
