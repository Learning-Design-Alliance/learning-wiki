---
type: claim
title: "Female principals enacted care through a 'listening then deciding' pattern of situational decision making"
description: "Female principals enacted care through a 'listening then deciding' pattern of situational decision making"
id: listening-then-deciding-situational-decision-making
status: draft
generated:
...
`q2 i?` In the name-calling dilemma, all three principals chose to investigate further with the teacher rather than reprimand the student immediately, weighing whether it was a one-time incident or a series of behaviors. [→ Kropiewnicki 2001 (2)](#kropiewnicki-2001-2)
...
> "Each principal's desire, to receive and understand the perspectives of others and formulate responses after gathering information, was reflective of Noddings' (1984) premise that a behavior of care is "stepping out of one's personal frame of reference into theother's" (p. 24)."
...
> "Rather than reprimand the student andleave the situation, each principal stated that they would investigate the situation further by discussing it with the teacher."
