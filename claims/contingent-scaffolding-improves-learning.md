...
> **Evidence** · 5 studies · `q3`–`q4` · `i1`–`i3`
...
`q3 i2` Students receiving fully contingent tutoring (support level adjusted responsively to each response) outperform students receiving fixed, moderate, or no support on both immediate and delayed tests of the same skill. [→ Pratt and Savoy-Levine 1998](#pratt-and-savoy-levine-1998)

`q3 i2` Contingent, interactive tutoring (questioning and hints rather than explaining and feeding back) produces similar immediate learning outcomes to non-interactive tutoring but significantly better transfer and greater student responsibility for learning. [→ Chi et al. 2001](#chi-et-al-2001)

`q4 i2` Among forms of dynamic assessment, scaffolding (contingent prompting and mediation) is more effective than coaching but less effective than explicit strategy training for cognitive tasks. [→ Swanson and Lussier 2001](#swanson-and-lussier-2001)

`q3 i1` Contingency, fading, and transfer of responsibility are the three defining characteristics of scaffolding in the literature; they are closely intertwined, and contingent support tends to produce fading and handover of responsibility automatically as learner competence grows. [→ van de Pol et al. 2010](#van-de-pol-et-al-2010)
...
`q3 · peer-reviewed within-subjects experiment` · `i2 · moderate effect on transfer` · `n=11 tutor-student pairs`
...
`q4 · meta-analysis of 30 studies` · `i2 · moderate effect` · `n=30 studies`
...
`q3 · systematic review of 66 articles (8 effectiveness studies)` · `i1 · small-to-moderate` · `n=66 articles`
...
`q3 · foundational observational study` · `i3 · large conceptual impact` · `n=30`
...
The evidence that contingent scaffolding outperforms non-contingent or absent support is real but narrower than it appears. Most effectiveness studies (Pratt & Savoy-Levine, Chi et al., Murphy & Messer) use one-to-one tutoring settings; generalizability to whole-class instruction is largely undemonstrated. Van de Pol et al. explicitly note that genuine contingency is scarce in practice — Myhill and Warren (2005, cited therein) observe that teaching contingently across 30 students simultaneously is exceptionally difficult. This implementation gap is a major design constraint: contingent scaffolding may work best when delivered through one-to-one human tutoring, small-group coaching, or adaptive intelligent tutoring systems.

A second qualification is the Swanson and Lussier finding: explicit strategy training outperforms contingent scaffolding for cognitive tasks. For instructional designers choosing between an approach built on contingent coaching versus one built on explicit strategy instruction, the evidence slightly favors the latter, at least for structured cognitive skills. Contingent scaffolding may have an advantage for transfer and self-regulation (per Chi et al.), even when immediate performance gains are similar.
