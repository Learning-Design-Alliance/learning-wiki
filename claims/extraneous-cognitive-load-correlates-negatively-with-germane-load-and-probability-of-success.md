---
type: claim
title: Self-reported extraneous cognitive load correlates negatively with germane load and with expected probability of success in an algebra task
description: Self-reported extraneous cognitive load correlates negatively with germane load and with expected probability of success in an algebra task
id: extraneous-cognitive-load-correlates-negatively-with-germane-load-and-probability-of-success
status: draft
generated:
...
`q2 i0` Extraneous cognitive load correlated negatively with QCM probability of success (r = -.191, p < .05). [→ Gupta 2020 (2)](#gupta-2020-2)
...
> "A negative correlation between extraneous cognitive load and germane cognitive load (r = -.264, p < .01) was detected which confirms Sweller et al.’s (1998) hypothesis about the negative relationship between extraneous and germane cognitive load."
...
> "Finally, extraneous cognitive load was found to correlate negatively with the probability of success (r = -.191, p < .05) in QCM."
