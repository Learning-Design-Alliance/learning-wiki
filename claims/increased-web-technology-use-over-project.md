---
type: claim
title: Both case-study teachers increased web and technology use for lesson preparation, presentation, and classroom exploration over the project
description: Both case-study teachers increased web and technology use for lesson preparation, presentation, and classroom exploration over the project
id: increased-web-technology-use-over-project
status: draft
generated:
...
`q2 i?` Both educators used NASA resources in three ways: as teaching resource, motivational classroom decoration, and sharing tool with peers. [→ Koszalka 2001 (2)](#koszalka-2001-2)
...
> "The web was used more often at t he end of the project by both educators to search for additional resources that would be used to support their teaching and as a presentation, prompting, or exploration tool in their classroom."
...
> "Both educators began to use NASA resources in three ways: teaching resource (supportive of presentation, inquiry, activity), motivational classroom decorations (supportive of explanation and inquiry), and as a sharing tool with peers"
