...
generated:
  ...
  at: 2026-08-30
id: worked-example-problem-sequences
...
**Open questions.** Whether alternating pairs outperform blocked example-then-problem sequences, how quickly support should be faded, and how these effects transfer across domains. Until targeted studies are added to the Evidence section, this page should be treated as a design hypothesis grounded in cognitive load theory rather than an independently supported claim.
