---
type: claim
title: Fluency Judgments Mislead Learners
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: fluency-judgments-mislead-learners
evidence_strength:
---
...
**Mechanism.** Processing fluency — the subjective ease of reading, recognizing, or re-experiencing material — is frequently misattributed to learning itself. When a text is clearly printed, a lecture is well-organized, or a concept has just been reread, learners experience ease and infer competence, even when actual retention or transfer is poor. This is a core driver of the [illusion of knowing](illusion-of-knowing.md) and of miscalibration between judged and actual learning.
...
- [Chunking reduces working memory load.](chunking-reduces-working-memory-load.md) — well-chunked material raises fluency, which can be misread as mastery
