...
The practical tension this claim describes sits directly alongside [interest-arousing instructional tactics](../theories/four-phase-interest-development.md) — the same category of move (a surprising fact, an eye-catching image, an anecdote) that triggers situational interest can backfire into seductive-detail interference if it doesn't genuinely connect to the target content. The individual-differences finding (Sanchez & Wiley, 2006) sharpens the practical guidance: struggling or lower-working-memory-capacity students are the ones most at risk from poorly-integrated "interesting" additions, which argues against treating decorative engagement tactics as a uniformly safe default, especially for students already struggling. The most defensible practical stance is to treat any interest-arousing addition as an empirical bet, not a guaranteed improvement — checking whether students appear to be learning *because of* an added feature, or *in spite of* it.
