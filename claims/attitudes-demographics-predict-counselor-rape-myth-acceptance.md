---
type: claim
title: "Attitudes, gender, and age predict counselors' rape myth acceptance in both label conditions"
description: "Attitudes, gender, and age predict counselors' rape myth acceptance in both label conditions"
id: attitudes-demographics-predict-counselor-rape-myth-acceptance
status: draft
generated:
...
`q3 i?` In the ATTS group, gender (β = .178) significantly predicted rape myth acceptance, explaining 7% of variance. [→ Litam 2019 (2)](#litam-2019-2)
...
> "The results of the regression were significant within the APPS group (R2 = 156, F(6,186) = 5.717, p < .05). Gender significantly predicted rape myth acceptance (β = .272, p < .05), as did age (β = .236, p < .05) and attitude (β = -.175, p < .05)."
...
> "The results of the regression were significant within the ATTS group (R2 = .065, F(6,194) = 2.231, p < .05). Gender significantly predicted rape myth acceptance (β = .178, p < .05) and explained 7% of the variance within the ATTS group."
