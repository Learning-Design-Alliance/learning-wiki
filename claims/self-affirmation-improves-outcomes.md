...
**Design implications pending evidence.** If the claim is confirmed, the practical form is a short values-writing activity placed before high-stakes moments — an exam, first feedback on drafts, entry into a stereotype-relevant field — rather than a recurring motivational exercise. It pairs naturally with [Belonging](../elements/belonging.md) supports and feedback practices that reduce the threat the affirmation must buffer; affirmation cannot compensate for instruction that is itself threatening or poorly structured.
