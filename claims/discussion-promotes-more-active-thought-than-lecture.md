...
`q2 i1` Synthesizing this and related literature, lecture is not effective for promoting thought, changing attitudes, or teaching behavioral skills, even though it can be an effective way to transmit information — no single method emerged as superior across all four common instructional objectives (acquiring information, promoting thought, changing attitudes, teaching behavioral skills). [→ Bligh 2000](#bligh-2000)
...
`q2 · large-scale review of comparison studies · i1 · null-to-small differences between lecture and most alternatives for information acquisition specifically · n=very large (90+ aggregated comparison studies)`
...
`q2 · comprehensive narrative research synthesis · i1 · consistent pattern across many underlying studies: lecture matches alternatives for information transfer but underperforms for thought, attitude change, and skill-building · n=synthesis across many contributing studies`
...
The core interpretive point is that "is lecture effective?" is the wrong question — effectiveness depends entirely on which of the four objectives (information, thought, attitude, skill) is actually being targeted. Lecture remains a reasonable choice when the goal really is information transmission, but a course that also wants students to think critically, shift attitudes, or build practical skill needs methods beyond lecture for those specific goals, since lecture alone has not been shown effective for any of the other three. This directly informs course-design choices among [Active Learning](../principles/active-learning.md), discussion-based methods, and [Traditional Lecture-Based Instruction](../patterns/traditional-lecture-based-instruction.md) — the choice should track the specific objective at hand rather than defaulting to one format for an entire course.
