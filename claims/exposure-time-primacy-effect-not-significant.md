---
type: claim
title: Increased exposure time did not significantly facilitate primacy (hypothesis 5 not supported)
description: Increased exposure time did not significantly facilitate primacy (hypothesis 5 not supported)
id: exposure-time-primacy-effect-not-significant
status: draft
generated:
...
> "The collapsing of arousal conditions over exposure times showed that an increase in exposure time almostdoubled the superiority of vimacy over recency (5.6%, 11.0%).However, this finding was not statistically significant"
