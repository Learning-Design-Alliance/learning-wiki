---
type: claim
title: SRL interventions in a four-week online mathematics preparation course did not significantly change the mathematics overall score (interaction marginal), while the mathematics focus score on self-chosen chapters showed a statistically significant group by time interaction
description: SRL interventions in a four-week online mathematics preparation course did not significantly change the mathematics overall score (interaction marginal), while the mathematics focus score on self-chosen chapters showe...
id: srl-interventions-math-overall-score-marginal-focus-score-significant-online-prep-course
status: draft
generated:
...
`q3 i?` The univariate ANOVA for the mathematics focus score revealed a statistically significant group by time interaction. [→ Bellhäuser 2022 (2)](#bellhauser-2022-2)
...
> "The interaction effect for the mathematics overall score, however, marginally missed the level of statistical significance although descriptive statistics indicated the hypothesized direction."
...
> "The univariate ANOVA for the mathematics focus score in fact revealed a statistically significant interaction effect between group and time (see Table 2)."

## Discussion


## Related Claims
- [Peer Feedback Groups Added To Web Based Srl Training Raise Srl Self Efficacy And Math Focus Score](peer-feedback-groups-added-to-web-based-srl-training-raise-srl-self-efficacy-and-math-focus-score.md)
