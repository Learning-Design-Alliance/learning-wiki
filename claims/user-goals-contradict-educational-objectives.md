---
type: claim
title: Individual user goals, such as avoiding cognitive load, can contradict the objectives of the educational community
description: Individual user goals, such as avoiding cognitive load, can contradict the objectives of the educational community
id: user-goals-contradict-educational-objectives
status: draft
generated:
...
`q2 i?` Perkins observed that an individual goal of many student computer users seems to be avoiding cognitive load, which contradicts the objectives of the educational community. [→ Gilbert 1999 (2)](#gilbert-1999-2)
...
> "The user's goals are often very different from what we might guess them to be. For example, we might think that an accounting clerk's goal is to process invoices efficiently. This is probably not true."
...
> "Perkins (1985) points out that an individual goal of many student users of computers seems to be "avoiding cognitive load," citing programming examples involving Logo."
