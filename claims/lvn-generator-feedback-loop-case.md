...
> "In this case, feedback loops served to push a programmatic goal forward by generating and utilizing knowledge across multiple partners and contexts to create an output of need. Had the LVP team chosen to rely on simple survey responses, the outputs may have been significantly different"
