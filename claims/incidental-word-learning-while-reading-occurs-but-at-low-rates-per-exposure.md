...
- [Automatic word recognition frees resources for comprehension](automatic-word-recognition-frees-resources-for-comprehension.md) — fluent word recognition determines whether attention is available for inferring unfamiliar word meanings from context
- [Chunking reduces working memory load](chunking-reduces-working-memory-load.md) — working-memory limits constrain how much novel word information can be extracted during reading
- [Cognitive load theory](../theories/cognitive-load-theory.md) — the theoretical framework explaining why inferring meanings while comprehending text competes for limited resources