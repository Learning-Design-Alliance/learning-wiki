---
type: claim
title: "In a kindergarten early algebra intervention, the teacher's equal-sign language shifted with lesson focus, from definitions and \"is the same as\" early on to \"balanced\" talk and balance gestures when evaluating and solving equations"
description: "In a kindergarten early algebra intervention, the teacher's equal-sign language shifted with lesson focus, from definitions and \"is the same as\" early on to \"balanced\" talk and balance gestures when evaluating and sol..."
id: teacher-shifts-equal-sign-language-with-kindergarten-lesson-focus
status: draft
generated:
...
`q1 i?` As lessons moved to evaluating and solving equations, the researchers saw an increase in the teacher describing equations as balanced (BAL) and using a balance gesture (GBAL). [→ Sung 2022 (2)](#sung-2022-2)
...
> "In fact, the number of times the teacher explicitly stated or used the definition of the equal sign (DEF), replaced the “=” with “is the same as” (ISA), and explicitly gestured to the sides of an equation (GSIDES) were greatest in this lesson."
...
> "As the focus of the lessons shifted towards using these concepts to evaluate and solve equations, we saw an increase in the teacher’s discussion of equations as “balanced” (BAL) and her use of a balance gesture when discussing equations (GBAL)."
