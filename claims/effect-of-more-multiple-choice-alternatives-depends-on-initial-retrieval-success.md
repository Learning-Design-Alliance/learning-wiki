---
type: claim
title: Having more multiple-choice alternatives benefits later retention when initial retrieval success is high but hurts learning when it is low
description: Having more multiple-choice alternatives benefits later retention when initial retrieval success is high but hurts learning when it is low
id: effect-of-more-multiple-choice-alternatives-depends-on-initial-retrieval-success
status: draft
generated:
...
`q2 i?` The chapter reports that when initial retrieval success is low, more alternatives hurt learning because selected incorrect responses are remembered. [→ Karpicke 2017 (2)](#karpicke-2017-2)
...
> "When the level of initial retrieval success is high, having more alternatives bene ﬁts subsequent retention."
...
> "However, when initial retrieval success is low, having more alternatives hurts learning. In this case, students are more likely to select incorrect responses on the initial test, and those incorrect responses are remembered on future tests."
