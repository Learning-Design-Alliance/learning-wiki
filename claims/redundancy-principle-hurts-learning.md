...
**Open questions.** The evidence base for this page still needs to be populated with primary studies and meta-analyses before the strength of the claim can be rated. Key open questions include how effect sizes vary across media (narration vs. text), age groups, and domains, and how much pacing control is needed to neutralize the effect.
