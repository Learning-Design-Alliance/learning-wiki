---
type: claim
title: Learner Generated Organizers Beat Provided Organizers
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: learner-generated-organizers-beat-provided-organizers
evidence_strength:
---
...
**Open questions.** No evidence entries are yet recorded on this page. Studies comparing learner-generated versus provided organizers (e.g., concept mapping and graphic organizer experiments) still need to be added before any strength rating can be assigned. Key comparisons to document include same-time-on-task controls (generation takes longer, so unequal-time comparisons overstate the advantage) and measures of *quality* of the generated organizer as a mediator of learning gains.

## Related Claims

- [Advance organizers improve learning](advance-organizers-improve-learning.md) — provided organizers are the comparison condition this claim is measured against
- [Annotating improves learning](annotating-improves-learning.md) — another learner-generated processing activity with similar generative mechanisms
...
- [Expertise reversal effect](../theories/expertise-reversal-effect.md) — provided scaffolds may beat generation for novices, reversing this claim's direction