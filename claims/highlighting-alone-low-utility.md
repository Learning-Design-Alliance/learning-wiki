---
type: claim
title: Highlighting Alone Low Utility
status: review
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: highlighting-alone-low-utility
...
- [Annotating improves learning](annotating-improves-learning.md) — generative annotation contrasts with passive highlighting.
- [Headings and highlight strategy](../strategies/"headings_and_highlight"_strategy.md) — a structured use of highlighting embedded in a larger strategy.
...
- [Chunking reduces working memory load](chunking-reduces-working-memory-load.md) — organization-based alternatives to surface-level marking.