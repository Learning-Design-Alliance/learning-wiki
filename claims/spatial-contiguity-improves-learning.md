---
type: claim
title: Spatial Contiguity Improves Learning
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: spatial-contiguity-improves-learning
evidence_strength:
---
...
- [Coherence principle: irrelevant material hurts learning.](coherence-principle-irrelevant-material-hurts-learning.md) — the complementary multimedia principle: removing extraneous material, like integrating essential material, reduces extraneous load
- [Cognitive overload degrades learning.](cognitive-overload-degrades-learning.md) — the working-memory mechanism that spatial contiguity is designed to prevent
- [Chunking reduces working memory load.](chunking-reduces-working-memory-load.md) — a parallel load-reduction strategy operating on segmenting rather than layout
- [Cognitive load theory.](../theories/cognitive-load-theory.md) — the theoretical framework from which the spatial contiguity principle derives
- [Expertise reversal effect.](../theories/expertise-reversal-effect.md) — explains why spatial integration benefits novices more than experienced learners