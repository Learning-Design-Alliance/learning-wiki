...
**Open questions.** How to operationalize and automate contingency (diagnosing when to fade) remains an active research problem, and evidence quality varies widely across scaffolding types (conceptual, procedural, metacognitive, motivational). Note also that this claim page currently has no Evidence entries; the subclaims above must be populated from primary studies before the strength rating can be treated as settled.
