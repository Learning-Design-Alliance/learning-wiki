---
type: claim
title: Learners misjudge the benefits of spaced practice
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: learners-misjudge-spacing
evidence_strength:
---
...
**Open questions.** The evidence base for this page is not yet populated; the specific studies establishing the size and generality of the misjudgment — including in authentic course settings rather than laboratory tasks — still need to be added before the strength of this claim can be rated. Until then, no evidence-strength rating is assigned.

## Related Claims

- [Chunking reduces working memory load](chunking-reduces-working-memory-load.md) — another case where perceived ease during study diverges from actual learning
- [Cognitive Load Theory](../theories/cognitive-load-theory.md) — the resource framework within which spacing and retrieval difficulty operate
