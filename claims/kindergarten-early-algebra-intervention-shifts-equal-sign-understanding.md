---
type: claim
title: "After an early algebra intervention, the number of kindergarteners giving a relational definition of the equal sign went from one to nine, and acceptance of non-standard equation forms rose, as reported from the authors' earlier study"
description: After an early algebra intervention, the number of kindergarteners giving a relational definition of the equal sign went from one to nine, and acceptance of non-standard equation forms rose, as reported from the autho...
id: kindergarten-early-algebra-intervention-shifts-equal-sign-understanding
status: draft
generated:
...
`q1 i?` Students accepting 5 = 2 + 3, 2 = 2 and 4 + 2 = 3 + 3 as valid went from nine, three and six before the intervention to 20, 17 and 13 after it. [→ Sung 2022 (2)](#sung-2022-2)
...
> "For example, we found that students grew in their ability to provide a relational definition of the equal sign (from one student prior to the intervention to nine students post-intervention)."
...
> "For example, prior to the intervention, only nine students accepted 5 = 2 + 3 as a valid equation, only three accepted 2 = 2, and only six accepted 4 + 2 = 3 + 3. At the conclusion of the intervention, these numbers grew to 20, 17, and 13, respectively."
