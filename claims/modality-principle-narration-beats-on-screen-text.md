---
type: claim
title: Modality Principle Narration Beats On Screen Text
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: modality-principle-narration-beats-on-screen-text
evidence_strength:
---
...
- [Coherence Principle: irrelevant material hurts learning](coherence-principle-irrelevant-material-hurts-learning.md) — same multimedia-learning family; both reduce extraneous processing
- [Cognitive overload degrades learning](cognitive-overload-degrades-learning.md) — the mechanism the modality principle is designed to prevent
- [Chunking reduces working memory load](chunking-reduces-working-memory-load.md) — complementary load-management technique for narrated segments
- [Dual Coding Theory](../theories/dual-coding-theory.md) — theoretical background on combining verbal and visual channels
- [Cognitive Load Theory](../theories/cognitive-load-theory.md) — the theoretical framework from which the modality principle derives