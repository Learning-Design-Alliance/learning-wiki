...
- **Summary quality matters.** Benefits accrue when summaries genuinely capture the structure of the material; poorly constructed summaries can reinforce misconceptions or omit critical content.
- **Timing and format.** Summarizing from memory (a closed-book summary) adds retrieval demands that may strengthen learning further, whereas open-book summarizing emphasizes selection and organization.
