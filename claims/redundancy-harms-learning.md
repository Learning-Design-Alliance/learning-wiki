...
**Open questions.** The claim currently lacks populated Evidence entries; the strength rating and subclaim structure should be finalized once primary studies (e.g., redundancy-effect experiments and multimedia meta-analyses) are ingested. The interaction between redundancy and learner-controlled pacing, and the threshold of expertise at which redundancy flips from harmful to helpful, remain under-specified.
