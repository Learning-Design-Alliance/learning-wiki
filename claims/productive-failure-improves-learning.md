---
type: claim
title: Productive Failure Improves Learning
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: productive-failure-improves-learning
evidence_strength:
---
...
- [Activation improves learning](activation-improves-learning.md) — failure attempts activate prior knowledge that instruction can then build on
- [Cognitive disequilibrium motivates conceptual change](cognitive-disequilibrium-motivates-conceptual-change.md) — being stuck creates the readiness that makes instruction effective
...
- [Example–problem sequences reduce cognitive load and improve learning outcomes](example-problem-sequences-reduce-cognitive-load-and-improve-learning-outcomes.md) — the instruction-first alternative that productive failure deliberately inverts