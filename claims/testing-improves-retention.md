...
**Note on evidence.** This page's Evidence section has not yet been populated with specific studies; the subclaims above therefore remain unverified until primary sources are added. The retrieval-practice literature is large and well-established, so populating this section — ideally with the major meta-analyses and the canonical restudy-comparison experiments — should be a high priority for a future enrichment pass.
