---
type: claim
title: Cooperative learning outperforms competitive and individualistic goal structures
status: review
generated:
...
- [Collaborative learning improves outcomes.](collaborative-learning-improves-outcomes.md) — the broader claim that peer collaboration benefits achievement, of which goal structure is one moderator
- [Cooperative learning](../patterns/cooperative-learning.md) — the instructional pattern implementing the five elements of positive interdependence and accountability
...
- [Social learning theory](../theories/social-learning-theory.md) — theoretical grounding for why peer interaction supports learning through observation and modeling
