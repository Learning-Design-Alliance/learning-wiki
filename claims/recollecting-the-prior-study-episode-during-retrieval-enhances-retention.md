---
type: claim
title: Inducing learners to recollect the prior study episode during retrieval practice enhances retention even when reexposure and initial success are held constant
description: Inducing learners to recollect the prior study episode during retrieval practice enhances retention even when reexposure and initial success are held constant
id: recollecting-the-prior-study-episode-during-retrieval-enhances-retention
status: draft
generated:
...
`q2 i?` The chapter reports, citing Whiffen and Karpicke (2017), that making list discrimination judgments produced about a 10% free recall advantage relative to restudy. [→ Karpicke 2017 (2)](#karpicke-2017-2)
...
> "On the ﬁnal tests, performance was consistently better when subjects had practiced retrieval (the recall condition) relative to when they generated the targets without thinking back to the original study episode (the generate condition)."
...
> "On a ﬁnal free recall test, the list discrimination condition produced about a 10% advantage relative to restudy."
