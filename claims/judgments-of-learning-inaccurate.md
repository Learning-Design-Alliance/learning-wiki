...
generated:
  ...
  at: 2026-08-30
id: judgments-of-learning-inaccurate
...
- [Assessment for learning improves achievement](assessment-for-learning-improves-achievement.md) — external assessment provides the corrective feedback that inaccurate self-judgments lack
- [Testing effect improves retention](testing-effect-improves-retention.md) — retrieval practice both strengthens memory and grounds JOLs in diagnostic cues
...
- [Interleaving improves learning](interleaving-improves-learning.md) — interleaved practice is systematically underjudged relative to blocked practice
- [Cognitive overload degrades learning](cognitive-overload-degrades-learning.md) — perceived difficulty and actual learning can dissociate, complicating self-monitoring
- [Self-regulated learning](../theories/self-regulated-learning.md) — accurate self-monitoring is a precondition for effective study-time allocation