---
type: claim
title: Pretesting Improves Retention
status: draft
generated:
  by: "claude/unspecified"
  at: 2026-08-30
id: pretesting-improves-retention
...
- [Retrieval practice improves long-term retention.](retrieval-practice-improves-retention.md) — pretesting is a retrieval attempt; this claim covers the post-instruction case
- [Activation improves learning.](activation-improves-learning.md) — pretesting may work partly by activating relevant prior knowledge
- [Cognitive disequilibrium motivates conceptual change.](cognitive-disequilibrium-motivates-conceptual-change.md) — failed pretests can create the knowledge gap that drives learning
- [Testing improves learning more than restudying.](testing-effect-improves-learning.md) — the broader testing-effect family of claims
