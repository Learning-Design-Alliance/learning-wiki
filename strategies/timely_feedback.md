...
description: Delivering feedback soon after performance so learners can still connect the information to the task, reducing error consolidation and enabling immediate correction.
status: review
generated:
...
3. Make feedback [Action-Oriented Feedback](../strategies/action-oriented_feedback.md) — state what to change and how, not just what was wrong.
...
## Related Strategies
- [Action-Oriented Feedback](action-oriented_feedback.md) — the content side of the same coin; timing determines whether actionable feedback arrives while it can still be used
