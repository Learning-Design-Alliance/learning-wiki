---
type: strategy
id: letter-to-the-reviewer-memo
title: Use a Letter to the Reviewer reflective memo submitted with each draft
description: A Letter to the Reviewer is a short reflective note or memo submitted with each draft in which students pinpoint both the strengths and weaknesses of their paper and request specific feedback that, from their perspect...
status: draft
generated:
...
### Context
#### Requirements
- Teachers should provide a list of questions or prompts as a guideline to help students compose their letters or memos
#### Constraints
- The technique is described from the author's own teaching experience rather than from a controlled study

### Target Learners
- student writers drafting and revising papers across a course

### Target Learning Goals
- reflective self-analysis of one's own writing
