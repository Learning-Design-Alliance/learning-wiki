---
type: strategy
id: retain-strengthen-improve-choice-options
title: Retain, strengthen, and improve statewide choice options, with urgent state action on information, oversight, and funding equity
description: "The report's central recommendation is that Minnesota \"retain, strengthen and improve our choice options\" rather than retreat from them."
status: draft
generated:
...
sources:
  - id: boyd-2002
    resource: "https://eric.ed.gov/?id=ED480198"
...
### Context
#### Requirements
- Continued state leadership to modify and improve the choice laws
#### Constraints
- Some needed modifications do not involve spending more money, but failure to act means state money will not be spent effectively and students will suffer

### Target Learners
- K-12 students in Minnesota, including at-risk secondary students and postsecondary-enrolling juniors and seniors

### Target Learning Goals
- Expanding access to educational settings suited to individual student needs, including individualized academics and workforce preparation
