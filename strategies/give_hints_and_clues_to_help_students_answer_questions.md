...
> **Evidence** · 4 claims (3 for, 1 mixed) · 10 studies, `q3`–`q4` · 10 of 10 report an effect size · 1 claim rests on one study
...
- Pino-Pasternak, D., van Deur, P., & Volet, S. (2014). Interventions scaffolding children's self-regulated learning: A review. *Educational Psychology Review, 26*(3), 361–397.
