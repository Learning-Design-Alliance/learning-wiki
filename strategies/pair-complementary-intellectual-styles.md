---
type: strategy
id: pair-complementary-intellectual-styles
title: Pair students with complementary intellectual styles to compensate for weaknesses
description: "Sternberg recommends pairing learners whose preferred styles differ so that each compensates for the other's weak areas, since people benefit most from collaborators moderately unlike themselves in preferred level of..."
status: draft
generated:
...
### Context
#### Requirements
- Partners must overlap moderately in preferred level of processing; no overlap risks communication breakdown, total overlap leaves functions ignored.
#### Constraints
- The recommendation is offered as a compensation mechanism when remediation of style weaknesses is not possible.

### Target Learners
- Students in classrooms and collaborative groups

### Target Learning Goals
- Flexibility in dealing with environment and narrowing gaps between weak and strong performance areas
