...
### Context
#### Requirements
- A teacher who can circulate freely during individual or group work (less feasible during whole-class lecturing from a fixed position)
...
2. Move casually toward the student or group while continuing the lesson or helping a nearby student — do not stop teaching or stare.
3. Position yourself within a few feet and remain occupied with legitimate instructional activity (checking work, answering a question).
4. If proximity alone does not re-engage the student, add a brief private prompt or [Check-In](../elements/check-in.md) rather than escalating publicly.
5. Move away once the student is back on task; lingering signals a standoff.
