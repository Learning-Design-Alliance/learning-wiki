---
type: strategy
id: guest-speaker-interviews-returnees
title: Have students interview study-abroad returnees to learn about living abroad first hand
description: Students prepare interview questions—beginners supported by structured question-writing tasks such as sentence-ordering worksheets—and interview returnees about their experiences overseas.
status: draft
generated:
...
### Context
#### Requirements
- Structured question-writing tasks for beginner-level students; returnees fluent enough to communicate in English with relative ease.
#### Constraints
- Used in upper-level elective or required freshmen courses in a Japanese university setting.

### Target Learners
- Japanese university EFL students, beginner to intermediate

### Target Learning Goals
- cross-cultural awareness
- interviewing and question-formulation skills
