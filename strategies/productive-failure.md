...
> **Evidence** · 6 claims (4 for, 2 mixed) · 10 studies, `q3`–`q4` · 8 of 10 report an effect size · 2 claims rest on one study
...
- Sinha, T., & Kapur, M. (2021). When problem solving followed by instruction works: Evidence for productive failure. *Educational Psychology Review, 33*, 1–28. [doi:10.3102/00346543211019105](https://doi.org/10.3102/00346543211019105)