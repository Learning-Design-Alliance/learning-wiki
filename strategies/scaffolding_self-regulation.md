...
### Context
#### Requirements
- Diagnostic knowledge of each learner's current regulatory skill — planning, monitoring, and emotional control — before selecting supports
- Explicit models of self-regulatory thinking ([Think-Aloud](../elements/think-aloud.md), [Modeling](../elements/modeling.md)) so learners can observe what planning and self-checking actually look like
...
2. **Model the regulatory process.** Use [Think-Aloud](../elements/think-aloud.md) to make planning, self-checking, and frustration management visible — including how to recover from errors.
3. **Set achievable goals.** Break tasks into steps with [Achievable Micro-Goals](../strategies/achievable_micro-goals.md) so learners experience success early and build efficacy.
4. **Practice with prompts.** Have learners execute the process with structured supports — [Check-In](../elements/check-in.md) routines, [Self-Assessment](../elements/self-assessment.md) rubrics, or [Choice Boards](../elements/choice-boards.md) that let them exercise planning decisions within safe bounds.
5. **Provide emotionally safe feedback.** Frame errors as diagnostic information; use [Action-Oriented Feedback](../strategies/action-oriented-feedback.md) focused on process and next steps rather than judgment.
6. **Fade support deliberately.** Remove prompts and check-ins as learners demonstrate independent use, shifting to periodic spot-checks ([Fading](../elements/fading.md)).
7. **Assess transfer.** Look for unprompted strategy use in new tasks, not just compliance during scaffolded ones.

## Related Strategies
- [Gradual Release of Responsibility](../strategies/gradual-release-of-responsibility.md) — the general I-do/we-do/you-do arc that self-regulation scaffolding follows
