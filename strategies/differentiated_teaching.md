...
- **Process differentiation** — varied [scaffolding](../elements/coaching.md), grouping, or pacing toward the same outcome
...
- Struggling learners, when differentiation raises support while holding goals constant [contingent-scaffolding-improves-learning](../claims/contingent-scaffolding-improves-learning.md) [+M]
- Advanced learners, who otherwise disengage or re-learn material [Guidance that helps novices can hinder more knowledgeable learners.](../claims/expertise-reversal-effect.md) [~S]
- Learners whose confidence depends on experiencing appropriate challenge and success [self-efficacy-predicts-academic-persistence](../claims/self-efficacy-predicts-academic-persistence.md) [+M]

### Target Learning Goals
- Mastery of core concepts and skills at varied entry points
- Transfer and application, when differentiated tasks all target the same understanding
...
- **[Khan Academy](https://www.khanacademy.org)** — mastery-based [adaptive-learning](../principles/adaptive-learning.md) paths let each student work at their own level on the same skill progression.
- **Reading workshop with leveled texts** — students read different texts on the same theme, then join a mixed [class-discussion](../elements/class-discussion.md) so all reach the shared discussion goal.
- **[Choice boards](../elements/choice-boards.md) for product differentiation** — students demonstrate understanding via essay, podcast, or diagram, all scored against the same rubric.
