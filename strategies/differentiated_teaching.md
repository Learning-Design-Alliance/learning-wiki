...
### Context
#### Requirements
- Requires teachers to assess and plan for diverse learning needs.
#### Constraints
- Can be time-consuming to plan and implement effectively.
...
### Affordances
- Accommodates diverse learning needs and ensures all students can master objectives.

### Personalization
- Adjustments can be made to content, process, and product based on individual needs.
