...
- ['What's My Emotion?' Game Check-In]('what's_my_emotion?'_game_check-in.md) — a low-stakes emotion-labeling warm-up that builds the vocabulary journaling depends on
