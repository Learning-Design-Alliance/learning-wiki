---
type: strategy
id: critical-thinking-and-philosophy-courses-in-teacher-education
title: Include courses on critical thinking and philosophy of education in teacher training programs
description: Based on the finding that critical thinking dispositions associate with contemporary educational philosophy preference, the authors recommend that teacher education programs offer courses on critical thinking and educ...
status: draft
generated:
...
### Context
#### Requirements
- Courses must address both critical thinking and educational philosophies within teacher training programs.
#### Constraints
- The recommendation rests on a correlational study; the article itself calls for experimental and qualitative research with different data collection tools to test such effects.

### Target Learners
- prospective teachers in teacher training programs
