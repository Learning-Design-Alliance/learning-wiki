...
> **Evidence** · 7 claims (6 for, 1 mixed) · 15 studies, `q3`–`q4` · 15 of 15 report an effect size · 1 claim rests on one study
...
## Related Strategies
- [Gradual Release of Responsibility](../strategies/gradual_release_of_responsibility.md) — the general instructional arc (I do, we do, you do) that this strategy applies to regulatory skills
- [Self-Monitoring Checklists](../strategies/self-monitoring_checklists.md) — a concrete scaffold that later becomes the learner's own tool
- [Goal-Setting Conferences](../strategies/goal-setting_conferences.md) — structures the planning phase of the self-regulation cycle
